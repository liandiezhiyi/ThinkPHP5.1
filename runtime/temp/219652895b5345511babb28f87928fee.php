<?php /*a:1:{s:63:"E:\phpstudy\WWW\tp5\application\admin\view\access\userList.html";i:1600329260;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
...
<script src="../../../../public/static/admin/index/js/pintuer.js"></script>
</head>
<body>
  ...
  <div class="panel admin-panel">
    ...
    <table class="table table-hover text-center">
      ...
      <?php if(is_array($userList) || $userList instanceof \think\Collection || $userList instanceof \think\Paginator): $i = 0; $__LIST__ = $userList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
        <tr>
          <td style="text-align:left; padding-left:20px;"><input type="checkbox" name="id[]" value="<?php echo htmlentities($vo['id']); ?>" /><?php echo htmlentities($vo['id']); ?></td>
          <td width="10%"><?php echo htmlentities($vo['login_name']); ?></td>
          <td><?php echo htmlentities($vo['group_name']); ?></td>
          <td><?php echo htmlentities($vo['gen_time']); ?></td>
